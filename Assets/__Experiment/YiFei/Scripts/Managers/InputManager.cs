...
public class InputManager : Manager<InputManager>
{
    ...
    private EInputType mCurrentInputType = EInputType.None;
    ...
    {
        character = hero;
        if (mCurrentInputType != type)
        {
            mCurrentInputType = type;
            mCurrentInputState = InputStateFactory.CreateInputState(type);
        }
    }
